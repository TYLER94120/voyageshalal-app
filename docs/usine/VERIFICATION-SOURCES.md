...
**Dernier changement constate le 2026-09-23 09:41 UTC**, par un robot GitHub.
...
- ce qui cloche : JSON illisible (Expecting value: line 1 column 1 (char 0)). Debut recu: '\x1f�\x08\x00\x00\x00\x00\x00\x04\x03ݒ�KD!\x14��\x15q�\x08�1�����e�x���M��0�ë\x10\r�\x03\x15=f\x11Q\x14\x03"r8W���Ff�\x10FK%f�\x16f�w\x0b!\x13r\t��p��\x0e�&?eO� �\x1a,D�,\x1c�\x00b��\x0c�N\u05f9��\x12�ͩ��'
...
- reponse : code 200, 13337 octets, type `application/json; charset=utf-8`
...
- reponse : code 200, 939731 octets, type `application/zip`
...
- reponse : code 200, 6051 octets, type `application/json`
- forme recue : `liste de 477 elements (str)`
