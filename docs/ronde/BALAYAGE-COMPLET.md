...
**Dernier changement constate le 2026-08-13 15:56 UTC.**

**1975 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-08-13 15:56 UTC, termine en 10 minutes. Un balayage
...
| 🟠 defaut | 87 | il la recoit, mais elle le dessert |
| 🟡 a surveiller | 14 | pas urgent, a ne pas laisser grossir |
...
| Site | Pages vues | Defauts | Plafond |
|---|---|---|---|
| voyageshalal.fr | 872 | 33 | 26 |
| gohalaltravel.com | 885 | 68 | 61 |
| halalgpt.fr | 214 | 0 | 0 |
| halalcheck.fr | 4 | 0 | 0 |
...
- **description en francais sur le domaine anglais** — mots francais : des, direction, sorti, sympa  
  `https://www.gohalaltravel.com/priere/fes/cafe-sympa-sorti-de-des-direction-berkane`
- **titre coupe par Google (62 car.)** — « Mosquée magnifique — Prayer spot in Berkane (community-share… »  
  `https://www.gohalaltravel.com/spot/sp_mrtftu4b_52671`
- **titre en francais sur le domaine anglais** — mots francais : magnifique, mosquee — « Mosquée magnifique — Prayer spot in Berkane (community-s… »  
  `https://www.gohalaltravel.com/spot/sp_mrtftu4b_52671`
- **titre coupe par Google (64 car.)** — « Mosquée Sidi slimane — Prayer spot in Berkane (community-sha… »  
  `https://www.gohalaltravel.com/spot/sp_mrthy3ne_hjxfv`
