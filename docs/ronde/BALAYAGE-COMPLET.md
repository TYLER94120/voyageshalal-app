...
**Dernier changement constate le 2026-09-08 07:26 UTC.**

**2046 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-09-08 07:26 UTC, termine en 10 minutes. Un balayage
...
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/destinations/shenzhen`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/hotels/hanoi`
- **description trop courte (24 car.)**  
