...
|---|---|---|
| 🔴 grave | **4** | le visiteur ne recoit pas la page |
...
|---|---|---|---|---|
| islampasapas.fr | 0 | 1 | 0 | 0 |
| voyageshalal.fr | 0 | 1 | 0 | 0 |
| gohalaltravel.com | 0 | 1 | 0 | 10 |
| halalgpt.fr | 0 | 1 | 0 | 0 |
...
- **le site entier ne repond pas** — code 402 — confirme au second controle  
