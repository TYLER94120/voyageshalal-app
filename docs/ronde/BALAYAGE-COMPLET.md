...
**Dernier changement constate le 2026-08-19 03:02 UTC.**

**2013 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-08-19 03:02 UTC, termine en 12 minutes. Un balayage
...
| 🟡 a surveiller | 29 | pas urgent, a ne pas laisser grossir |
...
| gohalaltravel.com | 885 | 25 | 11 | 10 |
| halalgpt.fr | 219 | 8 | 0 | 0 |
...
### gohalaltravel.com (14)

- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/osaka`
- **page lente (19.5 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/phuket`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/malmo`
- **page lente (19.7 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/blog/hijab-airport-security-check`
...
- **description trop courte (21 car.)**  
  `https://www.gohalaltravel.com/spot/sp_msnbwgey_0st3g`
- **page lente (20.3 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/spot/sp_msf72qww_41c1r`
- **description trop courte (42 car.)**  
  `https://www.gohalaltravel.com/spot/sp_ms8u2638_sreaa`
- **page lente (19.7 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/halal-questions/are-energy-drinks-halal`

### halalgpt.fr (8)

- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://halalgpt.fr/q/medicaments-gelules-halal`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://halalgpt.fr/q/e920-halal`
- **page lente (19.5 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://halalgpt.fr/q/oreo-halal`
- **page instable sous charge** — muette pendant la ronde, repond en 0.1 s au controle calme — a surveiller, pas a reparer  
  `https://halalgpt.fr/q/medicament-ramadan`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://halalgpt.fr/q/e270-acide-lactique-halal`
- **page lente (19.5 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://halalgpt.fr/q/cereales-halal`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://halalgpt.fr/q/psy-therapie-islam`
- **page lente (19.8 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://halalgpt.fr/q/nombre-rakat-priere`
