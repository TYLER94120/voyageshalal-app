...
**Dernier changement constate le 2026-09-02 07:19 UTC.**

**2048 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-09-02 07:19 UTC, termine en 13 minutes. Un balayage
...
| 🟡 a surveiller | 43 | pas urgent, a ne pas laisser grossir |
...
|---|---|---|---|---|
| islampasapas.fr | 41 | 11 | 11 | 0 |
| voyageshalal.fr | 871 | 18 | 0 | 0 |
| gohalaltravel.com | 892 | 36 | 11 | 10 |
...
- **page instable sous charge** — muette pendant la ronde, repond en 0.3 s au controle calme — a surveiller, pas a reparer  
  `https://www.voyageshalal.fr/hotels/yokohama`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.voyageshalal.fr/hotels/manille`
- **page instable sous charge** — muette pendant la ronde, repond en 0.1 s au controle calme — a surveiller, pas a reparer  
  `https://www.voyageshalal.fr/hotels/kairouan`
- **page instable sous charge** — muette pendant la ronde, repond en 0.7 s au controle calme — a surveiller, pas a reparer  
  `https://www.voyageshalal.fr/priere/casablanca/le-rendez-vous`
- **page instable sous charge** — muette pendant la ronde, repond en 0.7 s au controle calme — a surveiller, pas a reparer  
  `https://www.voyageshalal.fr/priere/marrakech/restaura-cafe-chill`
...
### gohalaltravel.com (25)

- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/mosque-near-me`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
...
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/destinations/dublin`
...
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/destinations/varanasi`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/destinations/port-louis`
- **page instable sous charge** — muette pendant la ronde, repond en 0.4 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/hotels/almaty`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/hotels/cordoue`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/hotels/lahore`
- **page lente (20.1 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/seoul`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/safi`
- **page lente (19.7 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/mostar`
- **page lente (19.4 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/budapest`
- **page instable sous charge** — muette pendant la ronde, repond en 0.2 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/hotels/mexico`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/lima`
- **page lente (19.6 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/san-diego`
- **page lente (20.1 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/montevideo`
- **page lente (19.7 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/hotels/varanasi`
- **description trop courte (41 car.)**  
