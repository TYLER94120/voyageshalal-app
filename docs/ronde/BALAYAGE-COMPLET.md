...
**Dernier changement constate le 2026-09-06 04:59 UTC.**

**2045 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-09-06 04:59 UTC, termine en 13 minutes. Un balayage
...
| 🟡 a surveiller | 13 | pas urgent, a ne pas laisser grossir |
...
| gohalaltravel.com | 892 | 16 | 10 | 10 |
...
- **page lente (8.8 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/destinations/pays/albanie`
- **description trop courte (24 car.)**  
