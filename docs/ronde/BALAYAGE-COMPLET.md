...
**Dernier changement constate le 2026-08-13 03:09 UTC.**

**1975 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-08-13 03:09 UTC, termine en 11 minutes. Un balayage
...
| 🟠 defaut | 85 | il la recoit, mais elle le dessert |
| 🟡 a surveiller | 24 | pas urgent, a ne pas laisser grossir |
...
- **titre coupe par Google (87 car.)** — « Resto Sidi koi Ali en bord de mer — Resto halal à Essaouira … »  
  `https://www.voyageshalal.fr/spot/sp_mselbxzb_9ujf8`
...
- **titre coupe par Google (61 car.)** — « Guide vivant halal de Marrakech — par la communauté (8 spots… »  
  `https://www.voyageshalal.fr/guide-vivant/marrakech`
...
- **titre coupe par Google (61 car.)** — « Where to pray in Marrakech — prayer spots | GoHalalTravel.co… »  
  `https://www.gohalaltravel.com/priere/marrakech`
- **titre coupe par Google (61 car.)** — « Where to pray in Essaouira — prayer spots | GoHalalTravel.co… »  
  `https://www.gohalaltravel.com/priere/essaouira`
- **titre coupe par Google (62 car.)** — « Where to pray in Casablanca — prayer spots | GoHalalTravel.c… »  
  `https://www.gohalaltravel.com/priere/casablanca`
- **titre coupe par Google (62 car.)** — « Where to pray in Tafoughalt — prayer spots | GoHalalTravel.c… »  
  `https://www.gohalaltravel.com/priere/tafoughalt`
- **titre coupe par Google (76 car.)** — « Where to pray at Hôtel excentre de Marrakech — Marrakech | G… »  
  `https://www.gohalaltravel.com/priere/marrakech/hotel-excentre-de-marrakech`
- **titre coupe par Google (74 car.)** — « Where to pray at Hôtel excentre magnifique — Marrakech | GoH… »  
  `https://www.gohalaltravel.com/priere/marrakech/hotel-excentre-magnifique`
- **titre en francais sur le domaine anglais** — mots francais : excentre, magnifique — « Where to pray at Hôtel excentre magnifique — Marrakech |… »  
  `https://www.gohalaltravel.com/priere/marrakech/hotel-excentre-magnifique`
- **description en francais sur le domaine anglais** — mots francais : excentre, magnifique  
  `https://www.gohalaltravel.com/priere/marrakech/hotel-excentre-magnifique`
- **titre coupe par Google (82 car.)** — « Where to pray at Resto Sidi koi Ali en bord de mer — Essaoui… »  
  `https://www.gohalaltravel.com/priere/essaouira/resto-sidi-koi-ali-en-bord-de-mer`
- **titre en francais sur le domaine anglais** — mots francais : bord, resto — « Where to pray at Resto Sidi koi Ali en bord de mer — Ess… »  
  `https://www.gohalaltravel.com/priere/essaouira/resto-sidi-koi-ali-en-bord-de-mer`
- **description en francais sur le domaine anglais** — mots francais : bord, resto  
  `https://www.gohalaltravel.com/priere/essaouira/resto-sidi-koi-ali-en-bord-de-mer`
- **titre coupe par Google (65 car.)** — « Where to pray at Mosquée magnifique — Berkane | GoHalalTrave… »  
  `https://www.gohalaltravel.com/priere/berkane/mosquee-magnifique`
- **titre en francais sur le domaine anglais** — mots francais : magnifique, mosquee — « Where to pray at Mosquée magnifique — Berkane | GoHalalT… »  
  `https://www.gohalaltravel.com/priere/berkane/mosquee-magnifique`
- **description en francais sur le domaine anglais** — mots francais : magnifique, mosquee  
  `https://www.gohalaltravel.com/priere/berkane/mosquee-magnifique`
- **titre coupe par Google (67 car.)** — « Where to pray at Mosquée Sidi slimane — Berkane | GoHalalTra… »  
  `https://www.gohalaltravel.com/priere/berkane/mosquee-sidi-slimane`
- **titre coupe par Google (88 car.)** — « Where to pray at Coin prière dans un restaurant familial — M… »  
  `https://www.gohalaltravel.com/priere/marrakech/coin-priere-dans-un-restaurant-familial`
- **titre en francais sur le domaine anglais** — mots francais : coin, dans, familial, priere — « Where to pray at Coin prière dans un restaurant familial… »  
  `https://www.gohalaltravel.com/priere/marrakech/coin-priere-dans-un-restaurant-familial`
- **description en francais sur le domaine anglais** — mots francais : coin, dans, familial, priere  
  `https://www.gohalaltravel.com/priere/marrakech/coin-priere-dans-un-restaurant-familial`
- **titre coupe par Google (63 car.)** — « Where to pray at Riad essaouira — Marrakech | GoHalalTravel.… »  
  `https://www.gohalaltravel.com/priere/marrakech/riad-essaouira`
- **titre coupe par Google (64 car.)** — « Where to pray at Le rendez vous — Casablanca | GoHalalTravel… »  
  `https://www.gohalaltravel.com/priere/casablanca/le-rendez-vous`
- **titre coupe par Google (92 car.)** — « Where to pray at Mosque a 10 minutes de saidia dans la monta… »  
  `https://www.gohalaltravel.com/priere/saidia/mosque-a-10-minutes-de-saidia-dans-la-montagne`
- **titre en francais sur le domaine anglais** — mots francais : dans, minutes, montagne — « Where to pray at Mosque a 10 minutes de saidia dans la m… »  
  `https://www.gohalaltravel.com/priere/saidia/mosque-a-10-minutes-de-saidia-dans-la-montagne`
- **description en francais sur le domaine anglais** — mots francais : dans, minutes, montagne  
  `https://www.gohalaltravel.com/priere/saidia/mosque-a-10-minutes-de-saidia-dans-la-montagne`
- **titre coupe par Google (68 car.)** — « Where to pray at Restaura Café chill — Marrakech | GoHalalTr… »  
  `https://www.gohalaltravel.com/priere/marrakech/restaura-cafe-chill`
- **titre coupe par Google (68 car.)** — « Where to pray at Resto avec piscine — Tafoughalt | GoHalalTr… »  
  `https://www.gohalaltravel.com/priere/tafoughalt/resto-avec-piscine`
- **titre en francais sur le domaine anglais** — mots francais : avec, piscine, resto — « Where to pray at Resto avec piscine — Tafoughalt | GoHal… »  
  `https://www.gohalaltravel.com/priere/tafoughalt/resto-avec-piscine`
- **description en francais sur le domaine anglais** — mots francais : avec, piscine, resto  
  `https://www.gohalaltravel.com/priere/tafoughalt/resto-avec-piscine`
- **titre coupe par Google (101 car.)** — « Where to pray at Resto traditionnel spécial jus de fruit et … »  
  `https://www.gohalaltravel.com/priere/marrakech/resto-traditionnel-special-jus-de-fruit-et-petit-dej`
- **titre en francais sur le domaine anglais** — mots francais : fruit, petit, resto, special, traditionnel — « Where to pray at Resto traditionnel spécial jus de fruit… »  
  `https://www.gohalaltravel.com/priere/marrakech/resto-traditionnel-special-jus-de-fruit-et-petit-dej`
- **description en francais sur le domaine anglais** — mots francais : fruit, petit, resto, special, traditionnel  
  `https://www.gohalaltravel.com/priere/marrakech/resto-traditionnel-special-jus-de-fruit-et-petit-dej`
- **titre coupe par Google (63 car.)** — « Where to pray at La dune agafay — Marrakech | GoHalalTravel.… »  
  `https://www.gohalaltravel.com/priere/marrakech/la-dune-agafay`
- **titre coupe par Google (62 car.)** — « Where to pray at Resto à Imsouane — Agadir | GoHalalTravel.c… »  
  `https://www.gohalaltravel.com/priere/agadir/resto-a-imsouane`
- **titre coupe par Google (84 car.)** — « Where to pray at Café sympa sorti de des direction berkane —… »  
  `https://www.gohalaltravel.com/priere/fes/cafe-sympa-sorti-de-des-direction-berkane`
- **titre en francais sur le domaine anglais** — mots francais : des, direction, sorti, sympa — « Where to pray at Café sympa sorti de des direction berka… »  
  `https://www.gohalaltravel.com/priere/fes/cafe-sympa-sorti-de-des-direction-berkane`
- **description en francais sur le domaine anglais** — mots francais : des, direction, sorti, sympa  
  `https://www.gohalaltravel.com/priere/fes/cafe-sympa-sorti-de-des-direction-berkane`
- **titre coupe par Google (67 car.)** — « Hôtel excentre de Marrakech — Other in Marrakech (community-… »  
  `https://www.gohalaltravel.com/spot/sp_ms1kzqor_ybexr`
- **titre coupe par Google (65 car.)** — « Hôtel excentre magnifique — Other in Marrakech (community-sh… »  
  `https://www.gohalaltravel.com/spot/sp_ms7iirki_ws5oz`
- **titre en francais sur le domaine anglais** — mots francais : excentre, magnifique — « Hôtel excentre magnifique — Other in Marrakech (communit… »  
  `https://www.gohalaltravel.com/spot/sp_ms7iirki_ws5oz`
- **titre coupe par Google (79 car.)** — « Resto Sidi koi Ali en bord de mer — Halal resto in Essaouira… »  
  `https://www.gohalaltravel.com/spot/sp_mselbxzb_9ujf8`
- … et 21 autres, liste complete dans `ronde.json`
...
- **page instable sous charge** — muette pendant la ronde, repond en 0.3 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/destinations/lisbonne`
