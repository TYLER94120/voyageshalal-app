...
**Dernier changement constate le 2026-09-26 08:00 UTC.**

**2059 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-09-26 08:00 UTC, termine en 11 minutes. Un balayage
...
- **page instable sous charge** — muette pendant la ronde, repond en 0.3 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/hotels/agadir`
- **page instable sous charge** — muette pendant la ronde, repond en 0.4 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/guides/traveling-during-ramadan`
- **page instable sous charge** — muette pendant la ronde, repond en 0.3 s au controle calme — a surveiller, pas a reparer  
  `https://www.gohalaltravel.com/guides/top-halal-destinations-2026`
- **description trop courte (24 car.)**  
...
- **page instable sous charge** — muette pendant la ronde, repond en 0.1 s au controle calme — a surveiller, pas a reparer  
  `https://halalgpt.fr/q/e250-nitrite-halal`
- **page instable sous charge** — muette pendant la ronde, repond en 0.1 s au controle calme — a surveiller, pas a reparer  
  `https://halalgpt.fr/q/e466-halal`
