...
**Dernier changement constate le 2026-09-11 05:04 UTC.**

**2052 pages regardees — le site entier.** Les chiffres ci-dessous
valent donc pour tout ce que Google peut voir.

Balayage commence le 2026-09-11 05:04 UTC, termine en 10 minutes. Un balayage
...
- **page lente (5.7 s)** — au-dela de 3 s, une part des visiteurs repart  
  `https://www.gohalaltravel.com/spot/sp_mselbxzb_9ujf8`
- **page lente (4.7 s)** — au-dela de 3 s, une part des visiteurs repart  
