...
**Dernier changement constate le 2026-09-11 09:56 UTC.**

⚠️ **Cette ronde a regarde 175 pages sur 2049 — environ 9 %.**
...
| 🟠 defaut | 4 | il la recoit, mais elle le dessert |
...
- **page instable sous charge** — muette pendant la ronde, repond en 36.6 s au controle calme — a surveiller, pas a reparer  
...
- **page instable sous charge** — muette pendant la ronde, repond en 36.7 s au controle calme — a surveiller, pas a reparer  
