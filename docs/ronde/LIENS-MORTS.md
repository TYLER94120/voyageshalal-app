...
Releve du **2026-08-13 05:49 UTC** · 2840 liens controles.

⚠️ **Ce tour a regarde 364 pages sur 1291 — environ 28 %.**
...
| | Combien | Qui repare |
|---|---|---|
| 🔴 liens **internes** morts | **10** | nous, c'est notre faute |
...
- `https://world.openfoodfacts.org` — code 502  
  *(sur halalcheck.fr)*
